      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-10">
        <div className="text-center">
          ...
          <h2 className="mt-6 font-display text-4xl leading-tight text-balance sm:text-5xl lg:text-6xl">
            Women's sports get <span className="italic text-plum">5%</span> of sponsorship deals.
            <span className="block mt-3">Pegasus is rewriting that math — with AI.</span>
          </h2>
          <p className="mx-auto mt-8 max-w-2xl text-lg text-muted-foreground">
            From a national fencer in Lyon to an Olympic climber in Tokyo, every athlete on Pegasus gets the same
            intelligent agent, lawyer and growth strategist — without traditional agency fees.
          </p>
        </div>
